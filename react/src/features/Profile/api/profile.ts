...
export const editProfile = async (request: ProfileEditRequest): Promise<ProfileType> => {
...
export const editProfileAddress = async (request: ProfileAddressRequest): Promise<ProfileType> => {
...
export const editProfilePay = async (request: ProfilePayRequest): Promise<ProfileType> => {
